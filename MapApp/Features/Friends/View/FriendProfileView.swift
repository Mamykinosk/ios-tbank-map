...
struct FriendProfileView: View {
    ...
    init(friend: FriendUser, showsCustomBackButton: Bool = true) {
        _viewModel = State(initialValue: FriendProfileViewModel(friend: friend))
...
private struct FriendMemoryPin: View {
    let memory: Memory
